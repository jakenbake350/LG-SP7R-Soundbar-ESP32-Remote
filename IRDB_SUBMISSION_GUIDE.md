# LG SPD7R Soundbar - IR Code Database Submission Guide

## Codes Successfully Captured
All 15 buttons from LG SPD7R soundbar remote (Model: AKB76038001) have been captured using NEC protocol.
...
2. Upload `LG_SPD7R_IRDB.csv`
3. Commit with message: "Add LG SPD7R soundbar IR codes (Model: AKB76038001)"

### Step 3: Create Pull Request
1. Go to the Pull Requests tab
2. Click "New Pull Request"
3. Title: "Add LG SPD7R soundbar remote codes"
4. Description:
   ```
   Adding IR codes for LG SPD7R 7.1 channel soundbar
...
2. Create a new gist with filename: `LG_SPD7R_IR_Codes.txt`
3. Paste the contents of `LG_SPD7R_IR_CODES.txt`
4. Make it public
...
- **LG_SPD7R_IRDB.csv** - Ready for IRDB database
- **LG_SPD7R_IR_CODES.txt** - Complete documentation with multiple formats
